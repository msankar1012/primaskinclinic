...
import imgAbout from '../../images/img-about.svg'
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6 pe-lg-5">
                                ...
                                <a href='https://primaskinandaesthetics.zohobookings.com/#/primaskinandaesthetics' target={'_blank'} rel={'noreferrer'} className='btn btn-primary btn-lg'>Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row flex-lg-row-reverse align-items-center">
                        ...
                        <div className="col-lg-6">
                            <figure className={'p-lg-3'}><img src={Img2} alt={pkg.name}/></figure>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container py-80">
                    <div className="row justify-content-center align-items-center">
                        <div className="col-lg-5 pe-lg-5">
                            <h2>About Me</h2>
                            <p>Dr. Mokanalakshmi R.M., a leading dermatologist specializing in dermatology, aesthetic medicine, and hair transplantation, combines extensive experience with a compassionate approach to deliver personalized patient care.</p>
                            <p>Awarded for her academic excellence and certified in the latest skincare advancements, she excels in non-surgical cosmetic treatments and laser technology, ensuring optimal results for every patient.</p>
                        </div>

                        <div className="col-lg-5">
                            <figure><img src={imgAbout} alt="Img"/></figure>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="row flex-lg-row-reverse align-items-center">
                        <div className="col-lg-5 ps-lg-5 mb-5 mb-lg-0">
                            ...
                            <p><svg className={'me-2 mb-1'} height='1em' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M493.6 163c-24.88-19.62-45.5-35.37-164.3-121.6C312.7 29.21 279.7 0 256.4 0H255.6C232.3 0 199.3 29.21 182.6 41.38C63.88 127.6 43.25 143.4 18.38 163C6.75 172 0 186 0 200.8v247.2C0 483.3 28.65 512 64 512h384c35.35 0 64-28.67 64-64.01V200.8C512 186 505.3 172 493.6 163zM464 448c0 8.822-7.178 16-16 16H64c-8.822 0-16-7.178-16-16V276.7l136.1 113.4C204.3 406.8 229.8 416 256 416s51.75-9.211 71.97-26.01L464 276.7V448zM464 214.2l-166.8 138.1c-23.19 19.28-59.34 19.27-82.47 .0156L48 214.2l.1055-13.48c23.24-18.33 42.25-32.97 162.9-120.6c3.082-2.254 6.674-5.027 10.63-8.094C229.4 65.99 246.7 52.59 256 48.62c9.312 3.973 26.62 17.37 34.41 23.41c3.959 3.066 7.553 5.84 10.76 8.186C421.6 167.7 440.7 182.4 464 200.8V214.2z"/></svg>
                                <a href="mailto:info@primaskin.in">info@primaskin.in</a></p>

                            <p className={'text-large pt-3 border-top border-light pb-2'}><b>Social media links</b></p>

                            <p className={'pb-0'}>
                                <a title={'Instagram'} className={'me-3'} href="https://www.instagram.com/prima_skin_and_aesthetics?igsh=MWxnY3g4a2huNnE3Mw==&utm_source=qr" rel="noreferrer" target='_blank'>
                                    <svg height='1.2em' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/></svg>
                                </a>
                                <a title={'YouTube'} href="https://www.youtube.com/channel/UC8M-BbYZM_gGx1AsWOlS0eQ" rel="noreferrer" target='_blank'>
                                    <svg height='1.05em' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24" id="youtube"><path d="M25 0H7C3.14 0 0 3.14 0 7v10c0 3.86 3.14 7 7 7h18c3.86 0 7-3.14 7-7V7c0-3.86-3.14-7-7-7zm5 17c0 2.757-2.243 5-5 5H7c-2.757 0-5-2.243-5-5V7c0-2.757 2.243-5 5-5h18c2.757 0 5 2.243 5 5v10z"></path><path d="m21.406 11.086-9-4A1 1 0 0 0 11 8v8a.999.999 0 0 0 1.406.914l9-4a1.001 1.001 0 0 0 0-1.828zM13 14.461V9.539L18.538 12 13 14.461z"></path></svg>
                                </a>
                            </p>
                        </div>
